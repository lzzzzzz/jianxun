package org.openmore.common.redisSubscribe;
...
public class RedisListenerBean {
    ...
    RedisMessageListenerContainer container(RedisConnectionFactory connectionFactory, MessageListenerAdapter listenerAdapter) {
        // 监听msgToAll
        container.addMessageListener(redisListenerHandle, new PatternTopic(msgToAll));
        //container.addMessageListener(redisListenerHandle, new PatternTopic(userStatus));
