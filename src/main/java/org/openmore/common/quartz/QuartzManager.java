...
public class QuartzManager {
     ...
     * 活动通知工作组
     */
    public static final String JOB_GROUP_NAME_ACTIVITY_NOTIFY = "ACTIVITY_NOTIFY";
    /**
     * 单独短信群发通知工作组
     */
    public static final String JOB_GROUP_NAME_SMS_BATCH = "SMS_BATCH_PUSH";

    /**
     * 默认触发器名
     */
    public static final String TRIGGER_NORMAL_NAME = "NORMAL_TRIGGER";
