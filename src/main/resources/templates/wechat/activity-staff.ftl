...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/css/wechat/activity-staff.css">
    <!--[if lt IE 9]>
...
<div class="activity ${(activityList?? && activityList?size gt 0)?string("had", "")}">
    <div class="activity-nav navbar-fixed-top">
        <div class="activity-nav-item current active">
            <p>最新活动</p>
        </div>
        <div class="activity-nav-item before">
            <p>往期活动</p>
        </div>
    </div>
    ...
    <div class="activity-list">
        <#if activityList?? && activityList?size gt 0>
            <#list activityList as activity>
                <a href="/wx/checkin/${activity.id}.html">
                    <div class="activity-item">
                        <div class="item-banner">
                            <img src="${(activity.bannerList[0].resourceUrl)!''}${(activity.bannerList[0].params)!''}"
                                 alt="">
...
<script src="/js/wechat/activity-staff.js"></script>
</body>
</html>